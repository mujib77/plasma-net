export default function HUD({ issData, solarWind, asteroidsData }) {
  return (
    <div style={{
      ...
      <div className="hud-brand" style={{ position: 'absolute', top: 28, left: 28 }}>
        <div style={{
        ...
        <div className="hud-brand-title" style={{
      ...
      <div className="hud-solar panel" style={{
        ...
        {solarWind?.storm && (
          <div style={{ marginTop: 10, fontSize: 9, letterSpacing: 3, color: '#ff4444' }}
            className="live-dot"
          >
            ⚠ GEOMAGNETIC STORM
          </div>
      ...
      <div className="hud-iss panel" style={{
      ...
      {asteroidsData && (
        <div className="hud-asteroids" style={{
